...
char* Chinese_character[14] = {"õ¢ðï", "ùÓÜ²", "õ¢Ø©", "ùÓØ©", "õ¢øÐ","ùÓøÐ", "õ¢ó³", "ùÓó³",
	"õ¢ßÚ","ùÓßÚ", "õ¢ÞÍ", "ùÓÞÍ", "õ¢íâ", "ùÓíâ"
} ;
...
Unit::Unit(char *str)
{
	...
	// ±âº¸°¡ ÇÑ±Û
		...
		if( gibo_len == killonly )
			kill_unit = Korean_to_English(gibo_str.substr(6,2)) ;
